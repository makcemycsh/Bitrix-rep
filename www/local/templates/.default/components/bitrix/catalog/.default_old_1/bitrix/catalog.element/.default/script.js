		...
		switch (this.productType)
		{
			...
			case 2://set
				if (this.product.useSlider)
				{
					...
					SliderImgs = BX.findChildren(this.product.slider.LIST, {tagName: 'option'}, true);
			...
			case 3://sku
				...
				for (i = 0; i < this.offers.length; i++)
				{
					...
					else
					{
						...
						SliderImgs = BX.findChildren(this.sliders[i].LIST, {tagName: 'option'}, true);
						if (!!SliderImgs && 0 < SliderImgs.length)
						{
							for (j = 0; j < SliderImgs.length; j++)
							{
	...
	if (-1 < index)
	{
		if (0 < this.offers[index].SLIDER_COUNT)
		{
			...
			if (-1 < indexPict)
			{
				...
				RowItems = BX.findChildren(this.sliders[index].LIST, {tagName: 'option'}, false);
				if (!!RowItems && 0 < RowItems.length)
				{
