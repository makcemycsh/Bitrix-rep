                ...
                <div id="panel">
                 <div class="bx_bigimages_imgcontainer">
                  <span class="bx_bigimages_aligner">
                   <a href="<?=$arResult['PREVIEW_PICTURE']['SRC']?>"><img id="<? echo $arItemIDs['PICT']; ?>" src="<?=$arResult['PREVIEW_PICTURE']['SRC']?>"></a>
             </span>
             <?
...
?>
<div class="hide <? echo $strClass; ?>" id="<? echo $arItemIDs['SLIDER_CONT_OF_ID'].$arOneOffer['ID']; ?>" style="display: <? echo $strVisible; ?>;">
      <div class="bx_slider_scroller_container">
       <div class="bx_slide">
...
if (!empty($arResult['DISPLAY_PROPERTIES']) || $arResult['SHOW_OFFERS_PROPS'])
{
   if (!empty($arResult['DISPLAY_PROPERTIES']))
   {
    ...
    <dl id="accordeon" class="accordeon">
     ...
     {
      ?>
      <dt class="accordeon-caption"><? echo $arOneProp['NAME']; ?></dt><dd class="accordeon-content <?if($flag){ echo "active"; $flag = false;}?>"><?
      echo (
...
<div class="item_position_buy">
    <div class="ipb_row_price">
       ...
       <div class="item_price">
        ...
        <div class="ipb_row_price" id="<? echo $arItemIDs['PRICE']; ?>"><? echo $minPrice['PRINT_DISCOUNT_VALUE']; ?></div>
...
<label><? echo htmlspecialcharsex($arProp['NAME']); ?>:</label>

<div class="<? echo $strClass; ?>" id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_cont">

      <div class="bx_size_scroller_container"><div class="bx_size">
            <select id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_list"  class="js-ul" style="width: <? echo $strWidth; ?>;margin-left:0%;">
              ...
              foreach ($arProp['VALUES'] as $arOneValue)
              {
               ...
               <option data-treevalue="<? echo $arProp['ID'].'_'.$arOneValue['ID'] ?>" data-onevalue="<? echo $arOneValue['ID']; ?>" style="width: <? echo $strOneWidth; ?>;display: none;" >
                  <?=$arOneValue['NAME']; ?>
 ...
 <div class="bx_scu_scroller_container"><div class="bx_scu">
       <select id="<? echo $arItemIDs['PROP'].$arProp['ID']; ?>_list" style="width: <? echo $strWidth; ?>;margin-left:0%;">
        ...
        foreach ($arProp['VALUES'] as $arOneValue)
        {
         $arOneValue['NAME'] = htmlspecialcharsbx($arOneValue['NAME']);
         ?>
         <option data-treevalue="<? echo $arProp['ID'].'_'.$arOneValue['ID'] ?>" data-onevalue="<? echo $arOneValue['ID']; ?>" style="width: <? echo $strOneWidth; ?>; padding-top: <? echo $strOneWidth; ?>; display: none;" >
...
<div class="ipb_row_buy cf">
   ...
   if ($arParams['USE_PRODUCT_QUANTITY'] == 'Y')
   {
         if ($arParams['SHOW_BASIS_PRICE'] == 'Y')
         {
             ...
             ?>
             <p id="<? echo $arItemIDs['BASIS_PRICE']; ?>" class="hide item_section_name_gray"><? echo GetMessage('CT_BCE_CATALOG_MESS_BASIS_PRICE', $basisPriceInfo); ?></p>
             <?
       }
       ...
       <div class="item_buttons vam">
            ...
            <div class="number">
                  ...
                  <input id="<? echo $arItemIDs['QUANTITY']; ?>" type="tel" class="tac transparent_input" value="<? echo (isset($arResult['OFFERS']) && !empty($arResult['OFFERS'])
                  ? 1
            ...
            <span class="item_buttons_counter_block" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" style="display: <? echo ($canBuy ? 'inline' : 'none'); ?>;">
             ...
             {
                  ?>
                  <a href="javascript:void(0);" class="in_cart" id="<? echo $arItemIDs['BUY_LINK']; ?>"> <i>
                      <svg class="icon-cart" width="14px" height="14.013px" viewBox="0 0 14 14.013">
                          <use xlink:href="#iconCart"></use>
                    </svg>
              </i><? echo $buyBtnMessage; ?></a>
              <?
        }
        if ($showAddBtn)
        {
            ?>
            <a href="javascript:void(0);" class="in_cart" id="<? echo $arItemIDs['ADD_BASKET_LINK']; ?>"> <i>
                <svg class="icon-cart" width="14px" height="14.013px" viewBox="0 0 14 14.013">
                    <use xlink:href="#iconCart"></use>
              </svg>
        </i><? echo $addToBasketBtnMessage; ?></a>
        <?
  }
  ?>
</span>
...
if ($arParams['DISPLAY_COMPARE'] || $showSubscribeBtn)
{
 ...
 <span class="item_buttons_counter_block">
      ...
      {
           ?>
           <a href="javascript:void(0);" class=in_cart" id="<? echo $arItemIDs['COMPARE_LINK']; ?>"><? echo $compareBtnMessage; ?></a>
           <?
     }
     if ($showSubscribeBtn)
     {
...
$(document).ready(function() {
      $('h1.page-title').empty();
      $('.js-ul option.bx_active').attr('selected', true);
