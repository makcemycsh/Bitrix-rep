...
global $APPLICATION;
?>
<div class="list_goods filter-result-content bx_catalog_top_home col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>">
<?
...
?>
	<div class="<? echo ($arItem['SECOND_PICT'] ? 'wrp_item_goods' : 'bx_catalog_item'); ?>">
		<div class="item_goods" id="<? echo $strMainID; ?>">
...
?>
 ...
 <span class="ig_name"><? echo $productTitle; ?></span> </a>
...
<div class="ig_rowinfo">
	...
	if (!empty($minPrice))
	{
		...
		{
			?>
 			<span  id="<? echo $arItemIDs['PRICE']; ?>"><?=$minPrice['VALUE']?><span class="rouble">o</span></span>
 			<span class="ig_weight">/ <?=$arItem['OFFERS']['0']['PROPERTIES']['SIZE']['VALUE']?></span>
...
<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="ig_buy cf">
 <a id="<? echo $arItemIDs['BUY_LINK']; ?>" href="javascript:void(0)" class="in_cart" rel="nofollow"> <i> </i>
<?
