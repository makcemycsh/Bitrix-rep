...
<div id="<?=$this->GetEditAreaId($arItem['ID']);?>">
	...
	if(is_array($arItem["PRICES"])):?>
		...
		if($arItem["PROPERTIES"]["PER"]["VALUE"] != ""):?>
			<?foreach($arItem["PRICES"] as $PRODUCT):?>

			

				<li><?=$PRODUCT["NAME"]?> - <span class="old-price"><?=$PRODUCT["PRICE"]?></span> <span class="new-price"><?=$PRODUCT['NEW_PRICE']?><span class="rouble">o</span></span></li>
			<?endforeach;?>
		<?
		//Товар без скидки
		else:?>
