...
<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
	...
	<div class="po_row po_row po_row_fio">
		<div class="por_label">Ф.И.О.</div>
		<div class="por_info">
			<input type="text">
		</div>
		<div class="por_right_label">
			Ваше имя и фамилия
		</div>
		<div class="por_error">
			Введите Ф.И.О.
	...
	<div class="po_row po_row_email">
		<div class="por_label">E-mail</div>
		<div class="por_info">
			<input type="text">
		</div>
		<div class="por_right_label">
	...
	<div class="po_row po_row_tel ">
		<div class="por_label">Телефон</div>
		<div class="por_info">
			<input type="text">
		</div>
		<div class="por_right_label">
			Номер телефона для уточнения ваших заказов
		</div>
		<div class="por_error">
